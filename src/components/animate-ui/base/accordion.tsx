  ...
  return (
    <AccordionItemContext.Provider value={{ isOpen, setIsOpen }}>
      <AccordionPrimitive.Item
        ...
        className={cn(
          'mb-4 rounded-xl border-2 border-[#333333]/60 bg-[#141414]/60  transition-all duration-200',
  ...
  return (
    ...
    >
      <AccordionPrimitive.Trigger
        ...
        className={cn(
          'flex flex-1 text-start items-center justify-between py-4 px-4 font-base text-base transition-colors',
          className
        )}
        {...props}
      >
        ...
        <AccordionPrimitive.Panel
          ...
          render={
            <motion.div
              ...
              {...motionProps}
            >
              <div className={cn('pb-4 pt-0 px-4 text-sm', className)}>{children}</div>
            </motion.div>
          }
          {...props}
        />
